...
const Forgot_EnterEmail = ({ navigation }) => {


  const onSubmit = (values, { resetForm }) => {
    resetForm();
    navigation.navigate('Forgot_EnterVerificationCode');
  };
    ...
    <View style={pagecss.containerFull}>
      ...
      >
        ...
        <>
          ...
          <Text style={formcss.formHead2}>Enter your email</Text>
          <TextInput
...
export default Forgot_EnterEmail;
